...
Library-level documentation not tied to a single theme lives under `src/docs/`. The first is `src/docs/color-palette/index.md` → `/docs/color-palette/`, reached from a `Docs` item in the global nav (`_includes/nav.html`).
